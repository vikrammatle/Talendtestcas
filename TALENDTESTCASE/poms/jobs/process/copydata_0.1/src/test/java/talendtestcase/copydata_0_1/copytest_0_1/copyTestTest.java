...
package talendtestcase.copydata_0_1.copytest_0_1;
...
/**
 * Job: copyTestTest Purpose: <br>
 * Description:  <br>
 * @author mansoorahmed.shaik@mail.nissan.co.jp
 * @version 7.2.1.20190909_1035-patch
 * @status 
 */
public class copyTestTest implements TalendJob {
	static {System.setProperty("TalendJob.log", "copyTestTest.log");}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(copyTestTest.class);
...
public String getFilepath(){
	...
	private final String jobName = "copyTest";
	private final String projectName = "TALENDTESTCASE";
...
private RunStat runStat = new RunStat();
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_z29j0CJgEeqxGOnX6Ppx_g", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(copyTestTest.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_TALENDTESTCASE_copyTest = new byte[0];
    static byte[] commonByteArray_TALENDTESTCASE_copyTest = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TALENDTESTCASE_copyTest.length) {
				if(length < 1024 && commonByteArray_TALENDTESTCASE_copyTest.length == 0) {
   					commonByteArray_TALENDTESTCASE_copyTest = new byte[1024];
				} else {
   					commonByteArray_TALENDTESTCASE_copyTest = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TALENDTESTCASE_copyTest, 0, length);
			strReturn = new String(commonByteArray_TALENDTESTCASE_copyTest, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TALENDTESTCASE_copyTest) {
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"/mnt/c/Testcase/Namelist.csv\"");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("Name")+"}]");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "/mnt/c/Testcase/Namelist.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("/mnt/c/Testcase/Namelist.csv", "ISO-8859-15",";","\n",true,0,0,
...
row3_tmp.Name = row2.Name ;
row3 = row3_tmp;
log.debug("tMap_1 - Outputting the record " + count_row3_tMap_1 + " of the output table 'row3'.");
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("/mnt/c/Testcase/Namelist.csv") instanceof java.io.InputStream)){
...
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'row3': " + count_row3_tMap_1 + ".");
                ...
                class BytesLimit65535_tFileCompare_1{
                    ...
                    log4jParamters_tFileCompare_1.append("Parameters:");
                        ...
                        log4jParamters_tFileCompare_1.append(" | ");
                            log4jParamters_tFileCompare_1.append("FILE" + " = " + "\"/mnt/c/Testcase/Namelist.csv\"");
                        log4jParamters_tFileCompare_1.append(" | ");
                            log4jParamters_tFileCompare_1.append("FILE_REF" + " = " + "\"/mnt/c/Talenddest/newd.csv\"");
                        log4jParamters_tFileCompare_1.append(" | ");
...
if (result_tFileCompare_1)
{
		...
		java.io.BufferedReader file_tFileCompare_1 = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream("/mnt/c/Testcase/Namelist.csv"),"ISO-8859-15"));
		java.io.BufferedReader fileRef_tFileCompare_1 = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream("/mnt/c/Talenddest/newd.csv"),"ISO-8859-15"));
 ...
 */
    ...
    public static void main(String[] args){
        final copyTestTest copyTestTestClass = new copyTestTest();

        int exitCode = copyTestTestClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'copyTest' - Done.");
	        }
      ...
      @Test
        public void testDefault() throws java.lang.Exception{
         if(1<=0){
            ...
            String instance_input_file1=null;
                java.net.URL url_input_file1 = getClass().getResource("/talendtestcase/copydata_0_1/copytest_0_1/datas/copyTest_Default_input_file1_Namelist.csv");
                instance_input_file1="input_file1=" + java.net.URLDecoder.decode(url_input_file1.getPath(), "UTF-8");
        ...
        copyTestTestClass.runJobInTOS(arrays);
        ...
        assertTrue("Failure="+nbFailure+java.lang.System.getProperty("line.separator")+errors, errors.isEmpty());
         ...
         if(copyTestTestClass.exception!=null){
            throw copyTestTestClass.exception;
        }
        }
      @Test
        public void testTest_Instance__1() throws java.lang.Exception{
         if(1<=0){
            throw new java.lang.Exception("There is no tAssert in your test case!");
          }
            junitGlobalMap.put("tests.log",new String());
            junitGlobalMap.put("tests.nbFailure",new Integer(0));
            final copyTestTest copyTestTestClass = new copyTestTest();
            java.util.List<String> paraList_Test_Instance__1 = new java.util.ArrayList<String>();
            paraList_Test_Instance__1.add("--context=Default");
        String[] arrays = new String[paraList_Test_Instance__1.size()];
        for(int i=0;i<paraList_Test_Instance__1.size();i++){
            arrays[i] = (String)paraList_Test_Instance__1.get(i);
        }
        copyTestTestClass.runJobInTOS(arrays);
    ...
    public int runJobInTOS(String[] args) {
        ...
        for (String arg : args) {
        	...
        	log.info("TalendJob: 'copyTest' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = copyTestTest.class.getClassLoader().getResourceAsStream("talendtestcase/copydata_0_1/copytest_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = copyTestTest.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : copyTestTest");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     89134 characters generated by Talend Cloud Real-Time Big Data Platform 
 *     on the December 19, 2019 7:47:32 PM GMT
 ************************************************************************************************/